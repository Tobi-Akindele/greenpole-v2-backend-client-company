...
public class Bondholder {
    ...
    private long bondholder_id;

    private String email, phone, gender, occupation, address, city, country, relationship, nuban, bvn, status;
    ...
    @JsonProperty("bondholder_type")
    @Column(name = "bondholder_type")
    String bondholderType;
    ...
    public long getBondholder_id() {
        return bondholder_id;
    }

    public void setBondholder_id(long bondholder_id) {
        this.bondholder_id = bondholder_id;
    }
    ...
    public String getBondholderType() {
        return bondholderType;
    }

    public void setBondholderType(String bondholderType) {
        this.bondholderType = bondholderType;
    }
    ...
    public int getBondUnit() {
        return bondUnit;
    }

    public void setBondUnit(int bondUnit) {
