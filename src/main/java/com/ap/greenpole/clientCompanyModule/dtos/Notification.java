...
public class Notification {
    ...
    private List<String> dataOwnerPhoneNumbers;
    @JsonProperty("dataOwnerEmails")
    private List<String> dataOwnerEmails;
    @JsonProperty("dataRequesterPhoneNumbers")
    private List<String> dataRequesterPhoneNumbers;
    @JsonProperty("dataRequesterEmails")
    private List<String> dataRequesterEmails;
    @JsonIgnore
