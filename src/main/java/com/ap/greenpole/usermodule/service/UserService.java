...
//        if (!adminRegisterKey.equals(user.getAdminRegisterKey())) {
//            return false;
//        }
    ...
    public void sendPasswordResetEmail(User user, String prefixUrl) throws NoSuchAlgorithmException, MessagingException, UnsupportedEncodingException {
        ...
        context.setVariable("supportEmail", supportEmailAddress);
        ...
        helper.setFrom(smptUserName, fineName);
    ...
    public void updateUser(User existing, User newData) throws FatalObjCopierException {
